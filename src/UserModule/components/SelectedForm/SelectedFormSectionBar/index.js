      ...
      return list.map(eachSection => {
         return (
            <Typo12DarkBlueGreyHKGroteskSemiBold
               key={eachSection.id}
               id={eachSection.id}
               onClick={() => this.onSelectSection(eachSection.id)}
            >
               <Span className=''>{eachSection.name}</Span>
            </Typo12DarkBlueGreyHKGroteskSemiBold>
         )
      })
   }
         ...
         <div>
            ...
            <Note>
               <Typo16DarkBlueGreyHKGroteskRegular>
                  <RedText>NOTE</RedText>
               </Typo16DarkBlueGreyHKGroteskRegular>
               <Typo16DarkBlueGreyHKGroteskRegular>
                  <BlackText>
                     : Only one set of snacks will be given to one individual
